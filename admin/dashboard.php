...
<div class="d-flex align-items-center justify-content-between">
  <a href="index.html" class="logo d-flex align-items-center">
    ...
    <span class="d-none d-lg-block">EZ-Code</span>
  </a>
...
<ul class="sidebar-nav" id="sidebar-nav">
    ...
    <ul id="courses" class="nav-content collapse " data-bs-parent="#sidebar-nav">
      <li>
        <a href="courses/create.php">
          <i class="bi bi-circle"></i><span>Create Courses</span>
        </a>
      </li>
      <li>
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" data-bs-target="#category" data-bs-toggle="collapse" href="#">
      <i class="bi bi-journal-text"></i><span>Enroll</span><i class="bi bi-chevron-down ms-auto"></i>
    </a>
    <ul id="category" class="nav-content collapse " data-bs-parent="#sidebar-nav">
      <li>
        <a href="enroll/index.php">
          <i class="bi bi-circle"></i><span>Manage Enroll</span>
        </a>
      </li>
